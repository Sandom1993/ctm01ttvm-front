            ...
            <div ref="pageBox" class="page-box">
                ...
                <div id="pageSearch" class="page-search">
                    <el-row :gutter="16">
                        ...
                        <el-col :span="3">
                            <div class="search-item">
                                <div style="margin-bottom: 4px">查询类别</div>
                                <el-select
...
export default {
    ...
    created() {
        getAllAlarmTypes({type: this.queryParams.type}).then(json => {
            if (json.code === '0') {
                const arr = [];
    ...
    methods: {
        ...
        filterChange(e) {
            ...
            const type = e === '' ? '0' : e;
            getAllAlarmTypes({type}).then(json => {
                if (json.code === '0') {
                    const arr = [];
                    json.data.forEach(item => {
                        const obj = {value: item.eventType, label: item.name};
        ...
        handleQuery() {
            ...
            params.label = {
                ...
                labels: [[{key: 'approveStatus', value: '0'}]]
            };
            if (dateRange) {
        ...
        handleOk() {
            ...
            const alarmRemark = this.checkForm.remark;
            const validObj = {
                '0': '误报',
                '1': '有效'
            };
