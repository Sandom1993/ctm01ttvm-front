...
<!--                                D08V36-->
                ...
                <el-tab-pane label="驾驶员信息" name="second">
                    <ul class="control-box-center" style="display:block;  padding-top:20px">
                        ...
                        <li>
                            ...
                            ${
                                info.attendanceDTO && info.attendanceDTO.certificateID
                                    ? info.attendanceDTO.certificateID
                                    : ''
                            }
                            </span>
                        </li>
                        <li>
                            ...
                            <span id="time" v-empty>
                                ${
                                    info.attendanceDTO && info.attendanceDTO.time
                                        ? info.attendanceDTO.time
                                        : ''
                                }
                          </span>
                        </li>
                ...
                <el-tab-pane label="车辆信息" name="third">
                    <ul class="control-box-center" style=" padding-top:20px">
                        <li>
                            <span class="control-label">运营区间</span>
                            <span id="runSection" v-empty>
                                ${ info.ibmData.runSection ? info.ibmData.runSection : ''}
                            </span>
                        </li>
                        <li>
                            <span class="control-label">公司名称</span>
                            <span v-empty>
                                ${ info.ibmData.companyName ? info.ibmData.companyName : '' }
                            </span>
                        </li>
                        <li>
                            <span class="control-label">车辆类型</span>
                            <span id="vehicleType1" v-empty>
                                ${ info.ibmData.vehicleType ? info.ibmData.vehicleType : ''}
                            </span>
                        </li>
                        <li>
                            <span class="control-label">所有人</span>
                            <span id="owner" v-empty>${ info.ibmData.owner ? info.ibmData.owner : ''}</span>
                        </li>
                        <li>
                            <span class="control-label">使用性质</span>
                            <span id="using" v-empty>${ info.ibmData.using ? info.ibmData.using : ''}</span>
                        </li>
                        <li>
                            <span class="control-label">品牌</span>
                            <span id="brand" v-empty>${ info.ibmData.brand ? info.ibmData.brand : '' }</span>
                        </li>
                        <li>
                            <span class="control-label">核定载人数</span>
                            <span id="limit" v-empty>${ info.ibmData.limit ? info.ibmData.limit : '' }</span>
                        </li>
