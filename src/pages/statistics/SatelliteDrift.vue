      ...
      >
        <el-table slot-scope="props" :data="props.data" force-scroll>
          ...
          <el-table-column
            ...
            label="速度（公里/小时）"
          ></el-table-column>
          <el-table-column label="GPS开始时间">
            <template slot-scope="scope">
              {{ scope.row.startTime | formateDateTime }}
            </template>
          </el-table-column>
          <el-table-column label="GPS结束时间">
            <template slot-scope="scope">
...
<script>
  ...
  import {
    querySatelliteDriftByVehicle,
    querySatelliteDriftDetail
  } from '../../api/satelliteDrift.js';
  ...
  export default {
    ...
    methods: {
      ...
      tableFetch(url, perPage, page) {
        ...
        return querySatelliteDriftByVehicle(params);
      },
      fetchDetail(url, perPage, page) {
        ...
        const params = {
          ...
          pageNo: page,
          pageSize: perPage,
          indexCode: this.detailRow.vehicleIndexCode
        };
        return querySatelliteDriftDetail(params);
      },
      ...
      onExport() {
        ...
        downloadExcel(
          `/${process.env.VUE_APP_CONTEXT}/statistic/vehicle/exportSatelliteDriftByVehicle.do`,
          params
        );
      ...
      onExportDetail() {
        ...
        downloadExcel(
          `/${process.env.VUE_APP_CONTEXT}/statistic/vehicle/exportSatelliteDriftDetail.do`,
          params
        );
