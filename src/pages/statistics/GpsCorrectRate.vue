        ...
        >
          ...
          >
            ...
            <el-table-column
              ...
              label="数据合格率"
            ></el-table-column>
            <el-table-column label="不合格数据" width="80">
              <template slot-scope="scope">
      ...
      >
        <el-table slot-scope="props" :data="props.data" force-scroll>
          ...
          <el-table-column
            ...
            label="错误类型描述"
          ></el-table-column>
          <el-table-column label="GPS时间">
            <template slot-scope="scope">
              {{ scope.row.gpsTime | formateDateTime }}
            </template>
          </el-table-column>
          ...
          <el-table-column
            ...
            label="速度（公里/小时）"
          ></el-table-column>
          <el-table-column label="海拔" prop="height"></el-table-column>
        </el-table>
      </h-paged-table>
    </el-dialog>
    <el-dialog
...
import {
  queryGpsCorrectRateByVehicle,
  queryIncorrectGpsDetail
} from '@/api/statistics';
...
export default {
  ...
  methods: {
    ...
    tableFetch(url, perPage, page) {
      ...
      this.pageNo = page;
      return queryGpsCorrectRateByVehicle(params);
    },
    fetchDetail(url, perPage, page) {
      ...
      const beginTime = new Date(
        new Date(this.detailRow.beginTime).setHours(0)
      );
      const params = {
        ...
        pageNo: page,
        pageSize: perPage,
        vehicleIndexCode: this.detailRow.vehicleIndexCode
      };
      this.detailPageNo = page;
      return queryIncorrectGpsDetail(params);
    },
    ...
    onExport() {
      ...
      downloadExcel(
        `/${process.env.VUE_APP_CONTEXT}/statistic/gps/gpsCorrectRateExport.do`,
        params
      );
    ...
    onExportDetail() {
      ...
      const params = {
        ...
        vehicleIndexCodes: this.detailRow.vehicleIndexCode
      };
      downloadExcel(
        `/${process.env.VUE_APP_CONTEXT}/statistic/gps/gpsInCorrectRateDetailExport.do`,
        params
      );
